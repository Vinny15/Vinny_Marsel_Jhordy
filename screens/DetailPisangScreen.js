...
export default class DetailPisangScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      product: {
        name:"Pisang Segar",
        description:"Pisang segar ini di jual per buah",
        created:"",
        images:[
          "https://topmedia.co.id/images/post/2019/02/640x400_pisang_.jpg", 
          "https://topmedia.co.id/images/post/2019/02/640x400_pisang_.jpg", 
          "https://topmedia.co.id/images/post/2019/02/640x400_pisang_.jpg", 
        ],
        colors:[
